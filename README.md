...
<img src="https://skillicons.dev/icons?i=html,css,js,ts,python,cs,php,r&theme=light title="html,css,js,ts,python,cs,php,r" alt="html,css,js,ts,python,cs,php,r""><br>
